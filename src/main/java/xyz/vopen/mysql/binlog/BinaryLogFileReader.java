...
import xyz.vopen.mysql.binlog.event.Event;
import xyz.vopen.mysql.binlog.event.deserialization.EventDeserializer;
...
public class BinaryLogFileReader implements Closeable {
    ...
    private final xyz.vopen.mysql.binlog.nio.ByteArrayInputStream inputStream;
    ...
    public BinaryLogFileReader (InputStream inputStream, EventDeserializer eventDeserializer) throws IOException {
        ...
        this.inputStream = new xyz.vopen.mysql.binlog.nio.ByteArrayInputStream(inputStream);
        try {
