...
import xyz.vopen.mysql.binlog.event.EventData;
import xyz.vopen.mysql.binlog.event.TableMapEventData;
import xyz.vopen.mysql.binlog.event.deserialization.json.JsonBinary;
